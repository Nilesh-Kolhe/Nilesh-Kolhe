...
const Home = () => {
    return (
        <div className="home-container">
            ...
            <a href="Resume.pdf" download="Full_Stack_Angular_React_Dot_Net_Dev.pdf"><button type="submit" style={{borderRadius: "8px", height: "35px", width: "160px", fontWeight: "lighter", fontSize: "small"}}> <img style={{height: "9px", width: "20px"}} src={`${download}`} alt="Download Icon" /> Download Resume</button></a>
        </div>
    );
}
